    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="alert alert-info">
                ...
                Profile Picture: <?php echo $om['profile_picture'] ? 'Yes' : 'No'; ?><br>
                Image Path: <?php echo $profile_img_src; ?><br>
                File Exists: <?php echo file_exists('../uploads/' . $om['profile_picture']) ? 'Yes' : 'No'; ?>
            </div>
            <?php endif; ?>
            <div class="card mb-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                  <div class="row mb-3">
                    <div class="col-md-3 text-center">
                      <?php 
                      $profile_img_src = $om['profile_picture'] ? '../uploads/' . htmlspecialchars($om['profile_picture']) : 'https://via.placeholder.com/120x120.png?text=Profile';
                      ?>
                      <img
